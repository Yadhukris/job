...
//alumni personal details and update
...
//     console.log("hai1")
//         await Jobdata.find().then(function(alljobs){
//             res.send(alljobs);
...
// })
console.log("hai1")
app.get('/dispjob', function (req, res) {
    console.log("h2")
    Jobdata.find()
...
app.post("/applyjob", async (req, res) => {
    ...
    // Jobdata.find().then(function(jobdata)
    // {
    //     console.log(jobdata)
    // }
...
//employerlist for admin home

app.get('/employerlist', function (req, res) {
